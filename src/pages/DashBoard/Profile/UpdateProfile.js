...
const UpdateProfile = () => {
    ...
    const { data: users, isLoading, refetch } = useQuery('users', () => fetch(`https://hello-tools-updated-server.vercel.app/api/v1/profile?email=${user?.email}`).then(res => res.json()))
    if (isLoading) {
        return <Loading />
    }
    ...
    const updateName = async data => {
        ...
        const url = `https://hello-tools-updated-server.vercel.app/api/v1/user/${users.email}`
        fetch(url, {
            method: 'PUT',
            headers: {
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch(`https://hello-tools-updated-server.vercel.app/api/v1/user/${users.email}`, {
                        method: 'PUT',
                        headers: {
                            'content-type': 'application/json'
                        },
