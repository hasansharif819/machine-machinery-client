...
const Summary = () => {
    return (
        <div className='bg-base-300 pb-10'>
            <h2 className='text-4xl font-bold mx-5 text-orange-400 py-5'>HELLO TOOLS</h2>
            <h2 className='text-4xl font-bold mx-5 text-orange-400 mb-10'>Company Business Summary</h2>
