        ...
        <div className="card w-96 glass cardBody">
          <figure id='inventoryImage'>
            ...
            <div className="card-actions">
              <Link to={`/products/${_id}`}><button onClick={() => navigateToDetail(_id)} className="btn bg-red-900 btn-sm bg-gradient-to-r from-orange-500 to-red-400" id='buttonID'>DETAILS</button></Link>
            </div>
          </div>
        </div>
      </Link>
